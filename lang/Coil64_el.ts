...
<context>
    ...
    <message>
        ...
        <translation>Το εύρος χωρητικότητας C&lt;sub&gt;V&lt;/sub&gt; (σε συνδυασμό με την αδέσποτη χωρητικότητα κυκλώματος) είναι πολύ στενό για να επικαλύπτει το επιθυμητό εύρος συχνοτήτων. Αλλάξτε το εύρος συχνοτήτων ή τις παραμέτρους του μεταβλητού πυκνωτή και δοκιμάστε ξανά.</translation>
    </message>
    <message>
        <location filename="../bandspread.cpp" line="294"/>
