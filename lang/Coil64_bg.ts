...
<context>
    ...
    <message>
        ...
        <translation>Диапазонът на капацитет C&lt;sub&gt;V&lt;/sub&gt; (комбиниран с паразитния капацитет на веригата) е твърде тесен, за да припокрие желания честотен диапазон. Моля, променете честотния диапазон или параметрите на променливия кондензатор и опитайте отново.</translation>
    </message>
    <message>
        <location filename="../bandspread.cpp" line="294"/>
