...
void PotCore::on_pushButton_calculate_clicked()
{
    ...
    d1 = loc.toDouble(ui->lineEdit_d1->text(), &ok1)*fOpt->dwInductanceMultiplier;
    d2 = loc.toDouble(ui->lineEdit_d2->text(), &ok2)*fOpt->dwInductanceMultiplier;
    d3 = loc.toDouble(ui->lineEdit_d3->text(), &ok3)*fOpt->dwInductanceMultiplier;
    d4 = loc.toDouble(ui->lineEdit_d4->text(), &ok4)*fOpt->dwInductanceMultiplier;
    h1 = loc.toDouble(ui->lineEdit_h1->text(), &ok5)*fOpt->dwInductanceMultiplier;
    h2 = loc.toDouble(ui->lineEdit_h2->text(), &ok6)*fOpt->dwInductanceMultiplier;
    b = loc.toDouble(ui->lineEdit_b->text(), &ok7)*fOpt->dwInductanceMultiplier;
    g = loc.toDouble(ui->lineEdit_g->text(), &ok8)*fOpt->dwInductanceMultiplier;
